...
# sudo curl https://www.bi7jta.cn/files/AndyTaylorTweet/updateScripts/Patch_Add_FreeDMR_China_Local_To_ServerList.sh | sudo sh
...
FreeDMR_China_LocalStr="FreeDMR_China_Local        9999    192.168.2.33                passw0rd    62031"
...
sed -i '/^FreeDMR_China_Local/d' "$dmr_hosts_file"
...
sed -i '/^FreeDMR_China_Local/d' "$dmr_hosts_file_custom"
