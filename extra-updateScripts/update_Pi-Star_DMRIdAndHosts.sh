...
sudo curl -# -o ${DMRIDFILE} https://www.bi7jta.cn/files/dmrids-and-hosts/DMRIds.dat --user-agent "Pi-Star_${pistarCurVersion}"
sudo curl -# -o ${P25HOSTS}  https://www.bi7jta.cn/files/dmrids-and-hosts/P25Hosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
sudo curl -# -o ${YSFHOSTS}  https://www.bi7jta.cn/files/dmrids-and-hosts/YSFHosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
sudo curl -# -o ${DMRHOSTS}  https://www.bi7jta.cn/files/dmrids-and-hosts/DMR_Hosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
sudo curl -# -o ${NXDNHOSTS}  https://www.bi7jta.cn/files/dmrids-and-hosts/NXDNHosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
sudo curl -# -o ${XLXHOSTS}  https://www.bi7jta.cn/files/dmrids-and-hosts/XLXHosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
