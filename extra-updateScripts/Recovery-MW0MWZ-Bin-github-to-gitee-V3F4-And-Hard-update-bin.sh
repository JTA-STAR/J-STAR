#!/bin/bash
# to https://gitee.com/BI7JTA/Pi-Star_v4_Binaries_Bin.git
# sudo curl https://www.bi7jta.cn/files/AndyTaylorTweet/updateScripts/Recovery-MW0MWZ-Bin-github-to-gitee-V3F4-And-Hard-update-bin.sh | sudo sh
...
# BIN二进制程序 
sudo sed -i  "s#https://gitee.com/BI7JTA/Pi-Star_v4_2_0_Binaries_Bin.git#https://gitee.com/BI7JTA/Pi-Star_v4_Binaries_Bin.git#g" /usr/local/bin/.git/config # 这里处理MW0MWZ版本V4的bin项目
