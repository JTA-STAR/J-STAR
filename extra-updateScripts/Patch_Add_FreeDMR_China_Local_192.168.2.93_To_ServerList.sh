...
# sudo curl https://www.bi7jta.cn/files/AndyTaylorTweet/updateScripts/Patch_Add_FreeDMR_China_Local_192.168.2.93_To_ServerList.sh | sudo sh
...
FreeDMR_China_LocalStr="FreeDMR_China_Local_192.168.2.93        9999    192.168.2.93                passw0rd    62031"
...
sed -i '/^FreeDMR_China_Local_192.168.2.93/d' "$dmr_hosts_file"
...
sed -i '/^FreeDMR_China_Local_192.168.2.93/d' "$dmr_hosts_file_custom"
...
echo "Id=460072402"
echo "Location=0"
echo "Name=FreeDMR_China_Local_192.168.2.93"
